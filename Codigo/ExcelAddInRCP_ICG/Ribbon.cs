using ExcelAddInRCP_ICG.Properties;
...
namespace ExcelAddInRCP_ICG
{
    ...
    public class Ribbon : Office.IRibbonExtensibility
    {
        ...
        {
            return GetResourceText("ExcelAddInRCP_ICG.Ribbon.xml");
        }
        ...
        public void Boton1(IRibbonControl control) { 
        
        }
        public Bitmap BotonImage(IRibbonControl control) {

            return Resources.distribucion2;
        }
        #endregion
